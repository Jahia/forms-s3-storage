...
<%@ taglib prefix="formfactory" uri="http://www.jahia.org/formfactory/functions" %>
    ...
    (function () {
        ...
        var saveBinaryToS3 = function($log, $compile, contextualData, ffDataFactory, ffTemplateResolver) {
            var directive = {
                restrict: 'E',
        ...
        angular
            .module('formFactory')
            .directive('ffSaveBinaryToS3', ['$log', '$compile', 'contextualData', 'ffDataFactory', 'ffTemplateResolver', saveBinaryToS3]);
    })();
